...
//  New MP game page to change some stuff around
// ===================================================================================
class BN4GamePageSP extends UT2K4GamePageBase;
...
DefaultProperties
{
    ...
    PanelClass(0)="BN4GUI.BN4Tab_GameTypeSP"
    PanelClass(1)="BN4GUI.BN4Tab_MainSP"
