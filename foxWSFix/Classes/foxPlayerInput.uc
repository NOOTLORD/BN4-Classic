...
//(NL)NOOTLORD: Use the BN4 settings menu instead of the UT2004 one
...
var bool bInputClassErrorCheck;
var float Desired43FOV;
var bool bCorrectZoomFOV;
var bool bCorrectWeaponFOV;
var bool bCorrectMouseSensitivity;
var float Desired43MouseSensitivity;
...
event PlayerInput(float DeltaTime)
{
	...
	if (bDoInit) {
		...
		//Just hook our custom BN4SettingsPage tabs here
		class'BN4SettingsPage'.default.PanelClass[2] = "foxWSFix.foxUT2K4Tab_PlayerSettings";
		class'BN4SettingsPage'.default.PanelClass[4] = "foxWSFix.foxUT2K4Tab_IForceSettings";
...
defaultproperties
{
	...
	Desired43FOV=90f
	bCorrectZoomFOV=false
	bCorrectWeaponFOV=false
