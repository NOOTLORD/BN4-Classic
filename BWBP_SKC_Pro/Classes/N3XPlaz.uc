...
defaultproperties
{
	 ...
	 PutDownSound=(Sound=Sound'BW_Core_WeaponSound.EKS43.EKS-Putaway',Volume=2.000000)
     ...
     GunLength=0.000000
     bAimDisabled=True
     FireModeClass(0)=Class'BWBP_SKC_Pro.N3XPlazPrimaryFire'
     FireModeClass(1)=Class'BWBP_SKC_Pro.N3XPlazSecondaryFire'
