...
defaultproperties
{
     ...
     //BigIconMaterial=Texture'BWBP_APC_Tex.Wrenchgun.BigIcon_Wrenchgun'
     ...
     //Mesh=SkeletalMesh'BWBP_APC_Anim.FPm_WrenchGun'
     DrawScale=1.250000
     Skins(0)=Shader'BW_Core_WeaponTex.Hands.Hands-Shiny'
     Skins(1)=Texture'BWBP_SKC_Tex.CoachGun.Coach-Main'
     //Skins(2)=Texture'BWBP_APC_Tex.Wrenchgun.WrenchShells'
     //Skins(3)=Texture'BWBP_APC_Tex.Wrenchgun.WrenchShells'
