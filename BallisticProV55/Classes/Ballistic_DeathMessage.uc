class Ballistic_DeathMessage extends BN4Deathmessage;
	...
	)
{
	...
	if (Switch == 3 && class<BallisticDamageType>(OptionalObject) != None && class'BallisticDamageType'.default.bSimpleDeathMessages)
		return class'GameInfo'.static.ParseKillMessage(KillerName, VictimName, default.Text $ class<BallisticDamageType>(OptionalObject).static.PeneDeathMessage(RelatedPRI_1, RelatedPRI_2));
