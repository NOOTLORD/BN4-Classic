...
//=============================================================================
class ConfigTab_Outfitting extends ConfigTabBase;
...
function LoadList()
{
	...
	lb_NewWeapons.CheckList.Add(Headings[1],,"Secondary",true);
	lb_NewWeapons.CheckList.Add(Headings[2],,"Primary",true);
	lb_NewWeapons.CheckList.Add(Headings[3],,"Explosives",true);
...
defaultproperties
{
     ...
     BoxNames(2)="Primary"
     //BoxNames(3)=""
     BoxNames(3)="Explosives"
     //Headings(0)=""
     Headings(0)="Primary"
     Headings(1)="Secondary"
     Headings(2)="Melee"
     Headings(3)="Explosives"
     //Headings(5)=""
     //Headings(6)=""
     //Headings(7)=""
     //Headings(8)=""
