...
{    
    ...
    Begin Object Class=MeleeEffectParams Name=ArenaPrimaryEffectParams
        ...
        BotRefireRate=0.99
        WarnTargetPct=0.3
        FireSound=(Sound=SoundGroup'BW_Core_WeaponSound.EKS43.EKS-Slash',Volume=0.5,Radius=24.000000,batten=false)
    End Object
    ...
    /*egin Object Class=WeaponParams Name=UniversalParams_Hot
		LayoutName="Superheated"
		LayoutTags="superheated"
		Weight=10
		AllowedCamos(0)=1
