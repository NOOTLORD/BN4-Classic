...
{
	Level.AddPrecacheMaterial(Texture'BW_Core_WeaponTex.OA-AR.OA-AR_Main');
	...
	Level.AddPrecacheMaterial(Texture'BW_Core_WeaponTex.OA-AR.OA-AR_Scope_Spec');
	Level.AddPrecacheMaterial(Texture'BW_Core_WeaponTex.RDS.RDS-Sight');
	Level.AddPrecacheMaterial(Texture'BW_Core_WeaponTex.RDS.RDS_Sight_SI');	
}
