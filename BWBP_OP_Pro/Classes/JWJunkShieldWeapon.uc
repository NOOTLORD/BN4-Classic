...
defaultproperties
{
	...
	NDCrosshairCfg=(Pic1=None,Pic2=Texture'BW_Core_WeaponTex.Crosshairs.R78OutA',USize1=128,VSize1=128,USize2=256,VSize2=256,Color1=(B=0,G=0,R=255,A=255),Color2=(B=0,G=123,R=255,A=255),StartSize1=96,StartSize2=96)
	...
	GroupOffset=4
	PickupClass=Class'BWBP_OP_Pro.JWJunkShieldPickup'
	PlayerViewOffset=(Y=75.000000,Z=-100.000000)
	AttachmentClass=Class'BWBP_OP_Pro.JWJunkShieldAttachment'
